...
<p><strong>Automated Image Analysis.</strong> We use an automated system to analyze pickup and return photographs of the Vehicle for damage, fuel level, and other condition factors. Renter acknowledges that this automated analysis is a non-binding aid only and <strong>is capable of error in either direction</strong>. Accordingly:
(a) <strong>If the automated analysis under-charges or misses damage</strong> (for example, if damage is not detected at return but is later confirmed by manual inspection or a body shop), we reserve the right to charge Renter the additional amount due — including repair cost, Loss of Use, Diminution of Value and administrative fees — as if the damage had been identified at return.
(b) <strong>If Renter believes the automated analysis over-charged</strong> (for example, flagged damage that was already present at pickup, mistook a shadow, dirt or reflection for damage, or misread the fuel level), Renter may notify us in writing within 7 days of return; we will investigate, and if we confirm the over-charge we will reimburse the disputed amount.
Renter agrees that automated determinations are subject to this two-way review and waives any claim that an automated reading is final or non-correctable.</p>
